// pub fn build(ast: AST, codepage: &'static encoding_rs::Encoding) -> Commands {
//     Commands(
...
// fn convert_vec(ast: &AST, statements: &[Statement]) -> Vec<(Instruction, Option<String>)> {
//     statements
//         .iter()
...
// fn convert(ast: &AST, statement: &Statement) -> Vec<(Instruction, Option<String>)> {
//     match statement {
//         Statement::If {
//             condition,
//             block,
